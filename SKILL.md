...
5. **Template Variety:** Support platform-specific templates (`templates/claude-code.md`, `templates/codex.md`) and agnostic ones (`templates/universal.md`).
...
Load `builder.md` from the `skill-gen` directory. Sanitize inputs, instantiate the workspace, and inject logic into the appropriate template (e.g., `templates/claude-code.md`, `templates/codex.md`, or `templates/universal.md`).
